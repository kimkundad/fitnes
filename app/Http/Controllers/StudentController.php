...
class StudentController extends Controller
{
    ...
    public function create()
    {
      ...
      $data['method'] = "post";
      $data['url'] = url('admin/admin_owner');
    ...
    $constraint->aspectRatio();
        ...
        $package->password = bcrypt($request['password']);
        $package->save();
        return redirect(url('admin/admin_owner'))->with('add_success','เพิ่มบัญชีผู้ใช้งาน เสร็จเรียบร้อยแล้ว');
    ...
    public function edit($id)
    {
      ...
      $data['objs'] = $cat;
      $data['url'] = url('admin/admin_owner/'.$id);
    ...
    public function update(Request $request, $id)
    {
     ...
     if($image == NULL){
      ...
      $constraint->aspectRatio();
       ...
       return redirect(url('admin/admin_owner/'.$id.'/edit'))->with('edit_success','เพิ่มบัญชีผู้ใช้งาน เสร็จเรียบร้อยแล้ว');
    ...
    public function destroy($id)
    {
      ...
      ->count();
        ...
        $obj = User::find($id);
        $obj->delete();
        return redirect(url('admin/admin_owner'))->with('delete','Delete successful');
