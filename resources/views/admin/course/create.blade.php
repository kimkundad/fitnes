                              ...
                              <div class="row">
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5 class="card-title">เพิ่ม Class เรียน</h5>
                                            <form class="" method="POST" action="{{$url}}" enctype="multipart/form-data">
                                              ...
                                              {{ csrf_field() }}
                                                ...
                                                <div class="position-relative form-group">
                                                  ...
                                                  <input name="course_name" placeholder="Yoka, Kick Boxing" type="text" class="form-control">
                                                </div>
                                                ...
                                                <div class="position-relative form-group">
                                                  ...
                                                  <input name="course_price" placeholder="1500" type="text" class="form-control">
                                                </div>

                                                <div class="position-relative form-group">
                                                  <label for="exampleEmail" class="">รายละเอียด</label>
                                                  <textarea name="course_detail" style="height:150px" class="form-control"></textarea>
                                                </div>
