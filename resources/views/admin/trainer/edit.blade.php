                                ...
                                <div class="col-md-6">
                                            ...
                                            <form class="" method="POST" action="{{$url}}" enctype="multipart/form-data">
                                              ...
                                              {{ csrf_field() }}
                                                ...
                                                <div class="position-relative form-group">
                                                  ...
                                                  <input name="trainer_name" placeholder="นายสมปอง อีกแล้ว" value="{{$objs->trainer_name}}" type="text" class="form-control">
                                                </div>
                                  ...
                                  @endif>{{$u->name_cat}}</option>
                                                ...
                                                <div class="position-relative form-group">
                                                  ...
                                                  <br />
                                                  <img width="250" class="rounded" src="{{url('assets/images/avatars/'.$objs->trainer_image)}}" >

                                                </div>

                                                <div class="position-relative form-group">
                                                  <label for="exampleEmail" class="">เปลี่ยนรูป Avatar</label>
                                                ...
                                                <div class="position-relative form-group">
                                                  ...
                                                  <input name="trainer_phone" placeholder="081-007-753" value="{{$objs->trainer_phone}}" type="text" class="form-control">
                                                </div>
