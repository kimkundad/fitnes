                    ...
                    <div class="app-sidebar__inner">
                        <ul class="vertical-nav-menu">
                            ...
                            <li>
                                ...
                                <ul class="mm-show">
                                  <li>
                                      <a href="{{url('admin/member')}}" {{ (Request::is('search_mem') ? 'class=mm-active' : '') }} {{ (Request::is('admin/member') ? 'class=mm-active' : '') }} {{ (Request::is('admin/preview/*') ? 'class=mm-active' : '') }} {{ (Request::is('admin/member/1*') ? 'class=mm-active' : '') }} {{ (Request::is('admin/member/1/history*') ? 'class=mm-active' : '') }} {{ (Request::is('admin/member/1/edit*') ? 'class=mm-active' : '') }}>
